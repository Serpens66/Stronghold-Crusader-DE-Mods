...
pushd "%PROJECT_DIR%"
"%MSBUILD%" SpawnCastle.csproj /p:Configuration=Debug /p:GameDir="%GAME_DIR%" /p:ExtenderDir="%EXTENDER_DIR%"
...
if "%BUILD_EXIT_CODE%"=="0" (
  ...
  set "PLUGIN_NAME=SpawnCastle_Serp"
  ...
  powershell.exe -NoProfile -ExecutionPolicy Bypass -File "%PROJECT_DIR%..\Shared\Release\Write-LocalBuildManifest.ps1" -ModName SpawnCastle
  if errorlevel 1 goto copy_failed
