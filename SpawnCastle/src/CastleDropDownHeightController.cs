...
namespace SpawnCastle
{
    ...
    {
        private const string ComboBoxName = "SpawnCastleSelectionComboBox";
            ...
            SpawnCastleSettingsViewModel settings)
        {
            ...
            if (view == null || comboBox == null)
            {
                Shared.DebugLogHelper.LogError(
                    log,
                    "SpawnCastle castle dropdown height controller could not attach; " +
            ...
            float availableHeight)
        {
            ...
            Shared.DebugLogHelper.LogWarning(
                log,
                "SpawnCastle castle dropdown used its safe height fallback because " +
            ...
            float availableHeight)
        {
            ...
            Shared.DebugLogHelper.LogInfo(
                log,
                "SpawnCastle castle dropdown height updated from current Noesis " +
