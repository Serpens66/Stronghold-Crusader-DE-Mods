...
CHIMP_TYPE_BEDOUIN_DEMOLISHER=0";
        ...
        public string StartTroopArmiesTitleText => SerpLocalization.Get("StartConditions.StartTroopArmiesTitle");
        public string ExtraStartUnitsTitleText => SerpLocalization.Get("StartConditions.ExtraStartUnitsTitle");
