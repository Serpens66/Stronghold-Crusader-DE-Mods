...
pushd "%PROJECT_DIR%"
"%MSBUILD%" SettingsMod.csproj /p:Configuration=Debug /p:GameDir="%GAME_DIR%" /p:ExtenderDir="%EXTENDER_DIR%"
...
if "%BUILD_EXIT_CODE%"=="0" (
  ...
  if not exist "%GAME_DIR%\BepInEx\plugins\SettingsMod" mkdir "%GAME_DIR%\BepInEx\plugins\SettingsMod"
  if not exist "%GAME_DIR%\BepInEx\plugins\SettingsMod\Override\ScriptExtenderUI" mkdir "%GAME_DIR%\BepInEx\plugins\SettingsMod\Override\ScriptExtenderUI"

  copy /Y "%PROJECT_DIR%BepInEx\plugins\SettingsMod\SettingsMod.dll" "%GAME_DIR%\BepInEx\plugins\SettingsMod\SettingsMod.dll"
  if errorlevel 1 goto copy_failed
  copy /Y "%PROJECT_DIR%BepInEx\plugins\SettingsMod\SettingsMod.pdb" "%GAME_DIR%\BepInEx\plugins\SettingsMod\SettingsMod.pdb"
  if errorlevel 1 goto copy_failed
  copy /Y "%PROJECT_DIR%BepInEx\plugins\SettingsMod\info.json" "%GAME_DIR%\BepInEx\plugins\SettingsMod\info.json"
  if errorlevel 1 goto copy_failed
  copy /Y "%PROJECT_DIR%BepInEx\plugins\SettingsMod\Override\ScriptExtenderUI\SettingsModSettings.xaml" "%GAME_DIR%\BepInEx\plugins\SettingsMod\Override\ScriptExtenderUI\SettingsModSettings.xaml"
  if errorlevel 1 goto copy_failed

  if exist "%GAME_DIR%\BepInEx\plugins\SettingsMod\ScriptExtenderUI\SettingsModSettings.xaml" del "%GAME_DIR%\BepInEx\plugins\SettingsMod\ScriptExtenderUI\SettingsModSettings.xaml"
  if exist "%GAME_DIR%\BepInEx\plugins\SettingsMod\Patches\Assets\GUI\XAML\MainHUD.xaml" del "%GAME_DIR%\BepInEx\plugins\SettingsMod\Patches\Assets\GUI\XAML\MainHUD.xaml"
  if exist "%GAME_DIR%\BepInEx\plugins\SettingsMod\Patches\Assets\GUI\XAMLResources\HUD_Buildings.xaml" del "%GAME_DIR%\BepInEx\plugins\SettingsMod\Patches\Assets\GUI\XAMLResources\HUD_Buildings.xaml"
  echo Plugin kopiert.
) else (
