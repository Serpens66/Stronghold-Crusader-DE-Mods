...
- Release metadata identifies APIShared consumers and pins bundle contents to APIShared 0.3.4. Thin archives exclude APIShared; bundle archives contain one validated APIShared copy. The SerpsMods package stages APIShared once as infrastructure and keeps consumers thin.
