...
set "PLUGIN_NAME=OxTetherIdleFixTest_Serp"
...
if not exist "%LOCAL_PLUGIN_DIR%\OxTetherIdleFixTest.dll" goto package_failed
...
echo Ox Tether Idle Fix Test built and installed successfully.
if "%NO_PAUSE%"=="0" pause
exit /b 0
