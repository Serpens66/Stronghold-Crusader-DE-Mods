...
public static class SerpLocalization
{
    ...
    public const string EnableAiStoneReserveFix = "BugfixesAndQoL.EnableAiStoneReserveFix";
    public const string EnableAiStoneReserveFixHelp = "BugfixesAndQoL.EnableAiStoneReserveFixHelp";
    ...
    private static readonly Dictionary<string, string> EnglishFallbacks = new Dictionary<string, string>
    {
        ...
        { "ExtendedData.StatusReady", "Package validated and ready." },
        { "ExtendedData.StatusChecking", "Waiting for the host package information." },
        { "ExtendedData.VanillaPackage", "Vanilla - no custom package" },
        { "ExtendedData.ErrorModDisabled", "Extended Data is disabled locally." },
        { "ExtendedData.ErrorPackageMissing", "The selected Coop Trail package is not installed:" },
        { "ExtendedData.ErrorFingerprintMismatch", "The local package contents differ from the host package." },
        { "ExtendedData.ErrorPackageInvalid", "The selected Coop Trail package is invalid:" },
        { "ExtendedData.ErrorPackageNotReady", "The selected Coop Trail package is not ready." },
        { "ExtendedData.ErrorParticipantNotReady", "At least one participant is missing the selected package or has different contents." },
        { "ExtendedData.ErrorParticipantsMissing", "Package missing for:" },
        { "ExtendedData.ErrorParticipantsMismatch", "Package contents differ for:" },
        { "ExtendedData.ErrorParticipantsNotReady", "Package status not ready for:" },
        ...
        { "CastlePlanner.SpawnBuildingsHelp", "Spawns all ordinary AIV buildings, including outposts." },
        ...
        { "CastlePlanner.Hud.Search", "Search" },
        { "CastlePlanner.Hud.SearchHelp", "Filters the AIVJSON list by file name." },
        { "CastlePlanner.Hud.IconScale", "Icon scale" },
        { "CastlePlanner.Hud.IconAlpha", "Icon opacity" },
        { "CastlePlanner.Hud.ShowFortifications", "Show fortifications" },
        { "CastlePlanner.Hud.ShowFortificationsHelp", "Shows walls, crenels, towers, gates, drawbridges, and stairs in the Blueprint." },
        { "CastlePlanner.Hud.ShowBuildings", "Show buildings" },
        { "CastlePlanner.Hud.ShowBuildingsHelp", "Shows regular castle buildings in the Blueprint." },
        { "CastlePlanner.Hud.ShowDefensiveGroundFeatures", "Show traps and ground defenses" },
        { "CastlePlanner.Hud.ShowDefensiveGroundFeaturesHelp", "Shows Killing Pits, Pitch Ditches, and Moats in the Blueprint." },
        { "CastlePlanner.Hud.ShowFearFactorBuildings", "Show Fearfactor buildings" },
        { "CastlePlanner.Hud.ShowFearFactorBuildingsHelp", "Shows positive and negative Fearfactor buildings in the Blueprint." },
        ...
        { "RandomEvents.MultiplayerModeHelp", "Shared events use one roll and strength for every eligible living player. Individual rolls give each eligible player separate chance and strength rolls. By default only humans are eligible; the AI option includes AI players. Both modes execute the resolved actions through the same tick-aligned Chore sequence to keep the simulation synchronized." },
        { "RandomEvents.MultiplayerShared", "Shared events" },
        { "RandomEvents.MultiplayerIndividual", "Individual rolls" },
        { "RandomEvents.IncludeAIPlayers", "Also affect AI players" },
        { "RandomEvents.IncludeAIPlayersHelp", "Includes living AI players in random-event targeting. Shared events use the same roll and strength for humans and AI; individual rolls are made separately for every player. Events affecting only AI players are not shown to human players." },
        ...
        { EnableAiStoneReserveFix, "Preserve stone for pending AI castle buildings" },
        { EnableAiStoneReserveFixHelp, "Preserves stone for the most expensive castle building that has not completed its first build before the AI sells stone." },
