...
public static class SerpLocalization
{
    ...
    private static readonly Dictionary<string, string> EnglishFallbacks = new Dictionary<string, string>
    {
        ...
        { "CustomCustomTrail.SupportedTrailSettings", "SUPPORTED MODS" },
        { "CustomCustomTrail.SupportedTrailSettingsHelp", "This list is generated automatically. Custom Trails save and load the host settings of these currently installed and supported mods." },
        ...
        { "CastlePlanner.Help", "Displays the selected AIVJSON as a local blueprint or spawns it in a new singleplayer game. All options in this mod remain local in multiplayer." },
