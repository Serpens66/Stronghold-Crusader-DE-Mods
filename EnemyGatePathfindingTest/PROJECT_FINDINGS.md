...
- Script Extender: `2.2.0`
- Geprüfter Script-Extender-Commit: `10d28f717d38166e5875c666f20fc5653ae44b0c`
...
Der Script Extender 2.2.0 detourt RVA `0x196280` weiterhin. Ein zusätzlicher überlappender nativer Hook wäre konflikt- und crashanfällig. Ausschließlich `UnitR3EventHooks.OnUnitMoveHere` verwenden.
...
- `MoveHere` weiterhin ausschließlich über den Script-Extender-2.2.0-Event, ohne zweiten Detour.
