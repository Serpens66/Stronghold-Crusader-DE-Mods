...
- Release: [v1.0.13](https://github.com/Serpens66/Stronghold-Crusader-DE-Mods/releases/tag/StartConditions/v1.0.13)
- Release commit: [6f78632](https://github.com/Serpens66/Stronghold-Crusader-DE-Mods/commit/6f78632523275399505323949c2dc9d3d1d9ba71)
...
Relevant localization keys: `Common.Ai`, `Common.ClientActivationLabel`, `Common.ClientSettingsActivationHelp`, `Common.HostActivationLabel`, `Common.HostSettingsActivationHelp`, `Common.Human`

## Diff

```diff
diff --git a/Shared/ActivePlayerHelper.cs b/Shared/ActivePlayerHelper.cs
index 28f72bcc..6dbabbad 100644
--- a/Shared/ActivePlayerHelper.cs
+++ b/Shared/ActivePlayerHelper.cs
@@ -3,54 +3,40 @@ using SHCDESE.Interop;
...
diff --git a/Shared/ActivePlayerKeepReadiness.cs b/Shared/ActivePlayerKeepReadiness.cs
new file mode 100644
index 00000000..98507544
--- /dev/null
+++ b/Shared/ActivePlayerKeepReadiness.cs
@@ -0,0 +1,238 @@
+using SHCDESE.API;
...
@@ -261,8 +286,8 @@ public static class SerpLocalization
...
@@ -379,6 +404,8 @@ public static class SerpLocalization
...
@@ -396,8 +423,16 @@ public static class SerpLocalization
...
index 57ef365d..1aca521c 100644
...
+      "Version": "1.0.16",
+      "Changes": [
+        "Apply gold, goods, troop types, and players independently so one failed start-condition operation does not block the remaining settings."
+      ]
+    },
+    {
+      "Version": "1.0.15",
+      "Changes": [
+        "Resolve active players exclusively from the synchronized in-game member roster and exclude kicked or defeated slots without simulation-derived fallbacks.",
+        "Wait up to 30 seconds on simulation ticks for every active player's Keep before applying start resources and troops, then fail once with detailed readiness diagnostics."
+      ]
+    },
+    {
+      "Version": "1.0.14",
+      "Changes": [
+        "Use Script Extender 1.41.0+'s corrected GetAlivePlayerIds result for deterministic start resources and troops, including early multiplayer Coop Trail map initialization.",
+        "Temporarily log Script Extender and legacy helper player lists side by side for multiplayer verification."
+      ]
+    },
     {
       "Version": "1.0.13",
...
index 71d4b0ea..ecae24ac 100644
...
index a3084165..13cad97d 100644
...
+Common.ClientSettingsActivationHelp=Aktiviert oder deaktiviert alle lokalen und persönlichen Client-Einstellungen dieser Mod.
 Common.Ai=KI
 Common.Human=Mensch
 StartConditions.StartGoldTitle=Startgold
...
diff --git a/StartConditions/BepInEx/plugins/StartConditions_Serp/Locales/uk-UA.txt b/StartConditions/BepInEx/plugins/StartConditions_Serp/Locales/uk-UA.txt
index 71d4b0ea..ecae24ac 100644
--- a/StartConditions/BepInEx/plugins/StartConditions_Serp/Locales/uk-UA.txt
+++ b/StartConditions/BepInEx/plugins/StartConditions_Serp/Locales/uk-UA.txt
@@ -1,6 +1,10 @@
 # Serp mod localization
 # Format: key=value
 Common.EnableMod=Enable Mod
...
diff --git a/StartConditions/BepInEx/plugins/StartConditions_Serp/Locales/zh-CN.txt b/StartConditions/BepInEx/plugins/StartConditions_Serp/Locales/zh-CN.txt
index 71d4b0ea..ecae24ac 100644
--- a/StartConditions/BepInEx/plugins/StartConditions_Serp/Locales/zh-CN.txt
+++ b/StartConditions/BepInEx/plugins/StartConditions_Serp/Locales/zh-CN.txt
@@ -1,6 +1,10 @@
 # Serp mod localization
 # Format: key=value
 Common.EnableMod=Enable Mod
