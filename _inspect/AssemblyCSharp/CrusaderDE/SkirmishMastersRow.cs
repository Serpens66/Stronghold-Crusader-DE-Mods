...
public class SkirmishMastersRow : INotifyPropertyChanged
{
	...
	private ImageSource _rowBackground;

	private ImageSource _alliesFace0;

	private ImageSource _alliesFace1;

	private ImageSource _alliesFace2;

	private ImageSource _alliesFace3;

	private ImageSource _alliesFace4;

	private ImageSource _alliesFace5;

	private ImageSource _alliesFace6;

	private ImageSource _alliesFace7;

	private ImageSource _alliesFaceBackground;

	private ImageSource _alliesFaceBackground0;

	private ImageSource _alliesFaceBackground1;

	private ImageSource _alliesFaceBackground2;

	private ImageSource _alliesFaceBackground3;

	private ImageSource _alliesFaceBackground4;

	private ImageSource _alliesFaceBackground5;

	private ImageSource _alliesFaceBackground6;

	private ImageSource _alliesFaceBackground7;

	private FRONT_SkirmishMasters parent;

	public EngineInterface.MPScoreData scoreData;

	public ObservableCollection<bool> SkirmishBriefingAlly { get; private set; }

	public ObservableCollection<bool> SkirmishBriefingAllyFight { get; private set; }

	public ObservableCollection<bool> SkirmishBriefingAllyDead { get; private set; }

	public ObservableCollection<bool> AlliesHumanFaceVis { get; private set; }
