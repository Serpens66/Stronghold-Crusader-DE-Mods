...
public class KeyManager : MonoBehaviour
{
	...
	private int[,] functionMap = new int[203, 2];

	private Enums.KeyFunctions[] directSentFunctions = new Enums.KeyFunctions[63]
	{
	...
	private PlaceHotKey[] buildingPlaceHotKeys = new PlaceHotKey[78]
	{
	...
	private void Update()
	{
		...
		if (Director.instance.SimRunning)
		{
			...
			{
				if (MainViewModel.Instance.HUDOptions.RefOptionsHotKeyPanel.Visibility == Visibility.Visible)
				{
		...
		{
			if (MainViewModel.Instance.OptionsNewsletterVis == Visibility.Visible)
			{
				MainViewModel.Instance.HUDOptions.ButtonClicked(-20001);
			}
			else if (MainViewModel.Instance.HUDOptions.RefOptionsHotKeyPanel.Visibility == Visibility.Visible)
			{
				MainViewModel.Instance.HUDOptions.ButtonClicked(-101);
			}
			else
		...
		else if (MainViewModel.Instance.Show_SandsTrail1Menu || MainViewModel.Instance.Show_SandsTrail2Menu || MainViewModel.Instance.Show_SandsTrail3Menu || MainViewModel.Instance.Show_SandsTrail4Menu || MainViewModel.Instance.Show_SandsTrail5Menu || MainViewModel.Instance.Show_SandsTrail6Menu || MainViewModel.Instance.Show_SandsTrail7Menu || MainViewModel.Instance.Show_SandsTrail8Menu)
		{
