...
public class FRONT_Extra7Campaign : UserControl
{
	...
	{
		NoesisUnity.LoadComponent((object)this, "Assets/GUI/XAMLResources/FRONT_Extra7Campaign.xaml");
	}
	...
	public void CampaignMenuCommandEnter(object sender, MouseEventArgs e)
	{
		...
		case "75":
		{
			int num = int.Parse(text, Director.defaultCulture) - 40;
			int difficulty = 0;
