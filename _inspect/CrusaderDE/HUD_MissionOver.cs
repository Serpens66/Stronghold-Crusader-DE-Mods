...
{
	public static HUD_MissionOver instance1 = null;

	public static HUD_MissionOver instance2 = null;
	...
	public bool SkirmishMasters;

	public bool SandsTrailOutro;

	public bool ShownWeaselTurd;

	public bool loopVideo;

	public Storyboard refSandsOutro;

	public Image RefMO_Sands_Mission_Bar_1;

	public Image RefMO_Sands_Mission_Bar_2;

	public Image RefMO_Sands_Mission_Bar_3;

	public Image RefMO_Sands_Mission_Bar_4;

	public Image RefMO_Sands_Mission_Bar_5;

	public Grid RefMO_SandsCurProgress;

	public Image RefMO_Sands_Trail_Bar_1;

	public Image RefMO_Sands_Trail_Bar_2;

	public Image RefMO_Sands_Trail_Bar_3;

	public Image RefMO_Sands_Trail_Bar_4;

	public Image RefMO_Sands_Trail_Bar_5;

	public Grid RefMO_SandsTrailProgress;

	public TextBlock RefWeaselTurdText1;

	public TextBlock RefWeaselTurdText2;

	public TextBlock RefWeaselTurdText3;

	public TextBlock RefWeaselTurdText4;

	public TextBlock RefWeaselTurdText5;

	public Grid RefCoopCompletion;

	public Storyboard refWeaselTurd1;

	public Storyboard refWeaselTurd2;

	public string[] victory_videos = new string[3] { "crusader_win.webm", "arabian_win.webm", "bedouin_win.webm" };

	public string[] defeat_videos = new string[3] { "crusader_lose.webm", "arabian_lose.webm", "bedouin_lose.webm" };
	...
	public int[][] individual_ranking;

	public int[] points = new int[9];

	public int[] enemy_killed = new int[9];

	public int[] yours_killed = new int[9];
	...
	public int mp_sortType;

	public bool sortReversed;

	public EngineInterface.MPScoreData last_stats;

	public const int RANK_ENEMY = 0;

	public const int RANK_BUILDINGS = 1;

	public const int RANK_FOOD = 2;

	public const int RANK_GOLD = 3;

	public const int RANK_POP = 4;

	public const int RANK_WOOD = 5;

	public const int RANK_STONE = 6;

	public const int RANK_IRON = 7;

	public const int RANK_PITCH = 8;

	public const int RANK_KOTH = 9;

	public const int RANK_YOUR = 10;

	public const int RANK_WEAPONS = 11;

	public const int RANK_BUILDLOST = 12;

	public const int RANK_TROOPSMADE = 13;

	public const int RANK_GOODSRECEIVED = 14;

	public const int RANK_GOODSSENT = 15;

	public static string FutureVoiceLine = "";

	public static DateTime FutureVoiceLineStart = DateTime.MinValue;

	public int[,] mp_help_text = new int[20, 2]
	{
		{ 225, 1 },
		{ 12, 18 },
		{ 12, 25 },
	...
	public HUD_MissionOver()
	{
		...
		refRankButton1 = (RadioButton)((FrameworkElement)this).FindName("RankButtonPage1");
		refRankButton2 = (RadioButton)((FrameworkElement)this).FindName("RankButtonPage2");
		refSandsOutro = (Storyboard)((FrameworkElement)this).TryFindResource((object)"SandsOutro");
		RefMO_Sands_Mission_Bar_1 = (Image)((FrameworkElement)this).FindName("MO_Sands_Mission_Bar_1");
		RefMO_Sands_Mission_Bar_2 = (Image)((FrameworkElement)this).FindName("MO_Sands_Mission_Bar_2");
		RefMO_Sands_Mission_Bar_3 = (Image)((FrameworkElement)this).FindName("MO_Sands_Mission_Bar_3");
		RefMO_Sands_Mission_Bar_4 = (Image)((FrameworkElement)this).FindName("MO_Sands_Mission_Bar_4");
		RefMO_Sands_Mission_Bar_5 = (Image)((FrameworkElement)this).FindName("MO_Sands_Mission_Bar_5");
		RefMO_SandsCurProgress = (Grid)((FrameworkElement)this).FindName("MO_SandsCurProgress");
		RefMO_Sands_Trail_Bar_1 = (Image)((FrameworkElement)this).FindName("MO_Sands_Trail_Bar_1");
		RefMO_Sands_Trail_Bar_2 = (Image)((FrameworkElement)this).FindName("MO_Sands_Trail_Bar_2");
		RefMO_Sands_Trail_Bar_3 = (Image)((FrameworkElement)this).FindName("MO_Sands_Trail_Bar_3");
		RefMO_Sands_Trail_Bar_4 = (Image)((FrameworkElement)this).FindName("MO_Sands_Trail_Bar_4");
		RefMO_Sands_Trail_Bar_5 = (Image)((FrameworkElement)this).FindName("MO_Sands_Trail_Bar_5");
		RefMO_SandsTrailProgress = (Grid)((FrameworkElement)this).FindName("MO_SandsTrailProgress");
		RefWeaselTurdText1 = (TextBlock)((FrameworkElement)this).FindName("WeaselTurdText1");
		RefWeaselTurdText2 = (TextBlock)((FrameworkElement)this).FindName("WeaselTurdText2");
		RefWeaselTurdText3 = (TextBlock)((FrameworkElement)this).FindName("WeaselTurdText3");
		RefWeaselTurdText4 = (TextBlock)((FrameworkElement)this).FindName("WeaselTurdText4");
		RefWeaselTurdText5 = (TextBlock)((FrameworkElement)this).FindName("WeaselTurdText5");
		refWeaselTurd1 = (Storyboard)((FrameworkElement)this).TryFindResource((object)"WeaselTurd1");
		refWeaselTurd2 = (Storyboard)((FrameworkElement)this).TryFindResource((object)"WeaselTurd2");
		RefCoopCompletion = (Grid)((FrameworkElement)this).FindName("CoopCompletion");
	...
	public void init()
	{
		...
		if (!initialised || (BaseComponent)(object)refMissionOverVideo1 == (BaseComponent)null || (BaseComponent)(object)refMissionOverVideo2 == (BaseComponent)null)
		{
			refMissionOverVideo1 = MainViewModel.Instance.IngameUI.refMissionOverVideo;
			refMissionOverVideo1.MediaEnded += new RoutedEventHandler(FrontendBackVideo_Ended);
			refMissionOverVideo2 = MainViewModel.Instance.FrontEndMenu.refMissionOverVideo;
			refMissionOverVideo2.MediaEnded += new RoutedEventHandler(FrontendBackVideo_Ended);
			initialised = true;
		}
	}
	...
	public void LoadVictoryScreen(Enums.VictoryScreens screen, EngineInterface.ScoreData lastScores)
	{
		...
		MainViewModel.Instance.MO_MP_Score = (Visibility)1;
		MainViewModel.Instance.MO_SandsOutro1 = (Visibility)1;
		Victory = true;
	...
	public void LoadDefeatScreen(Enums.DefeatScreens screen)
	{
		SkirmishMasters = false;
		SandsTrailOutro = false;
	...
	public void LoadMPVictoryScreen(Enums.VictoryScreens screen, EngineInterface.MPScoreData scoreData, bool skirmishMasters, bool sandsTrail)
	{
		...
		if (sandsTrail && !ConfigSettings.Settings_HideSoTTiming)
		{
			...
			MainViewModel.Instance.MO_SandsOutro1 = (Visibility)2;
			MainViewModel.Instance.MO_MP_Score = (Visibility)1;
		}
		else
		{
			SandsTrailOutro = false;
			MainViewModel.Instance.MO_SandsOutro1 = (Visibility)1;
			MainViewModel.Instance.MO_MP_Score = (Visibility)2;
		}
		MainViewModel.Instance.MO_MP_Victory = (Visibility)2;
		MainViewModel.Instance.MO_MP_Defeat = (Visibility)0;
		Victory = true;
	}

	public void LoadMPDefeatScreen(Enums.DefeatScreens screen, EngineInterface.MPScoreData scoreData)
	{
		SkirmishMasters = false;
		SandsTrailOutro = false;
		LoadVideoBackground("Defeat/" + defeat_videos[(int)screen]);
		...
		MainViewModel.Instance.MO_SandsOutro1 = (Visibility)1;
		MainViewModel.Instance.MO_MP_Score = (Visibility)2;
		MainViewModel.Instance.MO_MP_Victory = (Visibility)0;
		MainViewModel.Instance.MO_MP_Defeat = (Visibility)2;
		Victory = false;
	}

	public void ShowMPScore(EngineInterface.MPScoreData lastMPScores, bool prepScores = true, bool fromSkirmishMasters = false)
	{
		if (prepScores)
		{
			last_stats = lastMPScores;
			prepMPScores(lastMPScores);
			MainViewModel.Instance.MO_ShowPage1 = (Visibility)2;
			MainViewModel.Instance.MO_ShowPage2 = (Visibility)0;
			mp_sortType = 0;
			sortReversed = false;
			((ToggleButton)MainViewModel.Instance.HUDMissionOver.refRankButton1).IsChecked = true;
			...
			if (fromSkirmishMasters)
			{
				...
				{
					num = ((lastMPScores.trailLevel >= 22000) ? 102 : ((lastMPScores.trailLevel < 21000) ? 100 : 101));
		...
		{
			MainViewModel.Instance.MO_MP_PlayersVisible[k] = (Visibility)2;
		}
		for (int l = numActivePlayers; l < 8; l++)
		{
			MainViewModel.Instance.MO_MP_PlayersVisible[l] = (Visibility)0;
		}
		int num2 = 0;
		for (int m = 1; m < 9; m++)
		{
			...
			{
				playerIconsRow[num7] = (Visibility)2;
			}
			for (int num8 = 0; num8 < num5 && num8 < 7; num8++)
			{
				playerIconsRow[num8 + 7] = (Visibility)2;
			}
			...
			{
				playerIconsRow[14] = (Visibility)2;
			...
			{
				playerIconsRow[14] = (Visibility)0;
			}
			num2++;
		}
	}

	public void InitSands()
	{
		int seconds = 0;
		...
		case 11:
		{
			...
			for (int j = 0; j < 5; j++)
			{
				...
				int displayTime;
				int num4 = ((ConfigSettings.Settings_Trail_Sands1_Times[j] >= int.MaxValue) ? (displayTime = 0) : (displayTime = ConfigSettings.Settings_Trail_Sands1_Times[j] / 40));
				if (num4 <= 0)
				{
		...
		case 12:
		{
			...
			for (int n = 0; n < 7; n++)
			{
				...
				int displayTime;
				int num8 = (displayTime = ConfigSettings.Settings_Trail_Sands2_Times[n] / 40);
				if (num8 <= 0)
				{
		...
		case 13:
		{
			...
			for (int k = 0; k < 9; k++)
			{
				...
				int displayTime;
				int num5 = (displayTime = ConfigSettings.Settings_Trail_Sands3_Times[k] / 40);
				if (num5 <= 0)
				{
		...
		case 14:
		{
			...
			for (int m = 0; m < 11; m++)
			{
				...
				int displayTime;
				int num7 = (displayTime = ConfigSettings.Settings_Trail_Sands4_Times[m] / 40);
				if (num7 <= 0)
				{
		...
		case 15:
		{
			...
			for (int num9 = 0; num9 < 9; num9++)
			{
				...
				int displayTime;
				int num10 = (displayTime = ConfigSettings.Settings_Trail_Sands5_Times[num9] / 40);
				if (num10 <= 0)
				{
		...
		case 16:
		{
			...
			for (int l = 0; l < 9; l++)
			{
				...
				int displayTime;
				int num6 = (displayTime = ConfigSettings.Settings_Trail_Sands6_Times[l] / 40);
				if (num6 <= 0)
				{
		...
		case 17:
		{
			...
			for (int i = 0; i < 9; i++)
			{
				...
				int displayTime;
				int num3 = (displayTime = ConfigSettings.Settings_Trail_Sands7_Times[i] / 40);
				if (num3 <= 0)
				{
		...
		int num11 = GameData.GetSandsOfTimeRankTime(seconds, Enums.SandsRanks.Peasant);
		if (skirmishMissionDuration > num11)
		{
			skirmishMissionDuration = num11;
		}
		if (num11 <= 0)
		{
			num11 = 1;
		}
		MainViewModel.Instance.MO_Sands_CurProgressBar = 1500 - skirmishMissionDuration * 1500 / num11;
	...
	public void setProgressBar(int bar, int progress, int displayTime)
	{
	...
	public ObservableCollection<string> GetPlayerValuesRow(int rowID)
	{
		return rowID switch
		{
	...
	public ObservableCollection<Visibility> GetPlayerIconsRow(int rowID)
	{
		return rowID switch
		{
	...
	public void SetPlayerShieldsImageSource(int rowID, ImageSource image)
	{
		switch (rowID)
		{
		case 0:
	...
	public void SetPlayerFearImageSource(int rowID, ImageSource image)
	{
		switch (rowID)
		{
		case 0:
	...
	public ImageSource GetPlayerFear(int fearPie)
	{
		return MainViewModel.Instance.GameSprites[115 + fearPie];
	}

	public int calc_greatest_lord_points(EngineInterface.MPScoreData mp_stats, int this_player)
	{
		if (this_player < 0)
		{
			return 0;
	...
	public void prepMPScores(EngineInterface.MPScoreData mp_stats)
	{
		numActivePlayers = 0;
	...
	public void ClearWeaselText()
	{
		((UIElement)RefCoopCompletion).Visibility = (Visibility)1;
		((UIElement)RefWeaselTurdText1).Opacity = 0f;
		((UIElement)RefWeaselTurdText2).Opacity = 0f;
		((UIElement)RefWeaselTurdText3).Opacity = 0f;
		((UIElement)RefWeaselTurdText4).Opacity = 0f;
		((UIElement)RefWeaselTurdText5).Opacity = 0f;
		refWeaselTurd1.Stop();
		refWeaselTurd2.Stop();
	}
	...
	public void Update()
	{
		...
		if ((int)MainViewModel.Instance.MO_SandsOutro1 == 2)
		{
			int num = 1500 - (int)((FrameworkElement)RefMO_SandsCurProgress).Width;
			if (num < 188)
			{
				...
				((UIElement)RefMO_Sands_Mission_Bar_1).Opacity = 1f;
				((UIElement)RefMO_Sands_Mission_Bar_2).Opacity = 1f;
				((UIElement)RefMO_Sands_Mission_Bar_3).Opacity = 1f;
				((UIElement)RefMO_Sands_Mission_Bar_4).Opacity = 1f;
				((UIElement)RefMO_Sands_Mission_Bar_5).Opacity = 1f;
			}
			else if (num < 281)
			{
				...
				RefMO_Sands_Mission_Bar_4.Source = GameData.GetSandsOfTimeImage(Enums.SandsRanks.Tribesman, greyedImage: true);
				RefMO_Sands_Mission_Bar_5.Source = GameData.GetSandsOfTimeImage(Enums.SandsRanks.Peasant, greyedImage: true);
				((UIElement)RefMO_Sands_Mission_Bar_1).Opacity = 0.5f;
				((UIElement)RefMO_Sands_Mission_Bar_2).Opacity = 1f;
				((UIElement)RefMO_Sands_Mission_Bar_3).Opacity = 1f;
				((UIElement)RefMO_Sands_Mission_Bar_4).Opacity = 1f;
				((UIElement)RefMO_Sands_Mission_Bar_5).Opacity = 1f;
			...
			else if (num < 375)
			{
				...
				RefMO_Sands_Mission_Bar_5.Source = GameData.GetSandsOfTimeImage(Enums.SandsRanks.Peasant, greyedImage: true);
				((UIElement)RefMO_Sands_Mission_Bar_1).Opacity = 0.5f;
				((UIElement)RefMO_Sands_Mission_Bar_2).Opacity = 0.5f;
				((UIElement)RefMO_Sands_Mission_Bar_3).Opacity = 1f;
				((UIElement)RefMO_Sands_Mission_Bar_4).Opacity = 1f;
				((UIElement)RefMO_Sands_Mission_Bar_5).Opacity = 1f;
			}
			else if (num < 750)
			{
				...
				((UIElement)RefMO_Sands_Mission_Bar_1).Opacity = 0.5f;
				((UIElement)RefMO_Sands_Mission_Bar_2).Opacity = 0.5f;
				((UIElement)RefMO_Sands_Mission_Bar_3).Opacity = 0.5f;
				((UIElement)RefMO_Sands_Mission_Bar_4).Opacity = 1f;
				((UIElement)RefMO_Sands_Mission_Bar_5).Opacity = 1f;
			}
			else
			{
				...
				((UIElement)RefMO_Sands_Mission_Bar_2).Opacity = 0.5f;
				((UIElement)RefMO_Sands_Mission_Bar_3).Opacity = 0.5f;
				((UIElement)RefMO_Sands_Mission_Bar_4).Opacity = 0.5f;
				((UIElement)RefMO_Sands_Mission_Bar_5).Opacity = 1f;
			}
			int num2 = 1700 - (int)((FrameworkElement)RefMO_SandsTrailProgress).Width;
			if (num2 < 213)
			{
				...
				((UIElement)RefMO_Sands_Trail_Bar_1).Opacity = 1f;
				((UIElement)RefMO_Sands_Trail_Bar_2).Opacity = 1f;
				((UIElement)RefMO_Sands_Trail_Bar_3).Opacity = 1f;
				((UIElement)RefMO_Sands_Trail_Bar_4).Opacity = 1f;
				((UIElement)RefMO_Sands_Trail_Bar_5).Opacity = 1f;
			}
			else if (num2 < 318)
			{
				...
				RefMO_Sands_Trail_Bar_4.Source = GameData.GetSandsOfTimeImage(Enums.SandsRanks.Tribesman, greyedImage: true);
				RefMO_Sands_Trail_Bar_5.Source = GameData.GetSandsOfTimeImage(Enums.SandsRanks.Peasant, greyedImage: true);
				((UIElement)RefMO_Sands_Trail_Bar_1).Opacity = 0.5f;
				((UIElement)RefMO_Sands_Trail_Bar_2).Opacity = 1f;
				((UIElement)RefMO_Sands_Trail_Bar_3).Opacity = 1f;
				((UIElement)RefMO_Sands_Trail_Bar_4).Opacity = 1f;
				((UIElement)RefMO_Sands_Trail_Bar_5).Opacity = 1f;
			...
			else if (num2 < 425)
			{
				...
				RefMO_Sands_Trail_Bar_5.Source = GameData.GetSandsOfTimeImage(Enums.SandsRanks.Peasant, greyedImage: true);
				((UIElement)RefMO_Sands_Trail_Bar_1).Opacity = 0.5f;
				((UIElement)RefMO_Sands_Trail_Bar_2).Opacity = 0.5f;
				((UIElement)RefMO_Sands_Trail_Bar_3).Opacity = 1f;
				((UIElement)RefMO_Sands_Trail_Bar_4).Opacity = 1f;
				((UIElement)RefMO_Sands_Trail_Bar_5).Opacity = 1f;
			}
			else if (num2 < 850)
			{
				...
				((UIElement)RefMO_Sands_Trail_Bar_1).Opacity = 0.5f;
				((UIElement)RefMO_Sands_Trail_Bar_2).Opacity = 0.5f;
				((UIElement)RefMO_Sands_Trail_Bar_3).Opacity = 0.5f;
				((UIElement)RefMO_Sands_Trail_Bar_4).Opacity = 1f;
				((UIElement)RefMO_Sands_Trail_Bar_5).Opacity = 1f;
			}
			else
			{
				...
				((UIElement)RefMO_Sands_Trail_Bar_2).Opacity = 0.5f;
				((UIElement)RefMO_Sands_Trail_Bar_3).Opacity = 0.5f;
				((UIElement)RefMO_Sands_Trail_Bar_4).Opacity = 0.5f;
				((UIElement)RefMO_Sands_Trail_Bar_5).Opacity = 1f;
			}
		}
	}
	...
	public void ButtonClicked(string param)
	{
		...
		case "Troops":
			...
			return;
		case "Eco":
			MainViewModel.Instance.MO_ShowPage1 = (Visibility)0;
			MainViewModel.Instance.MO_ShowPage2 = (Visibility)2;
			mp_sortType = 0;
			sortReversed = false;
			((ToggleButton)MainViewModel.Instance.HUDMissionOver.refRankButton2).IsChecked = true;
			ShowMPScore(last_stats, prepScores: false);
			return;
		case "Rank":
			if (mp_sortType != 0)
		...
		if (SandsTrailOutro && (int)MainViewModel.Instance.MO_MP_Score == 2)
		{
			MainViewModel.Instance.MO_SandsOutro1 = (Visibility)2;
			MainViewModel.Instance.MO_MP_Score = (Visibility)1;
			return;
		...
		if (GameData.Instance.game_type == 3 && Director.instance.WasSkirmishModeGame && !ShownWeaselTurd)
		{
			if (Victory && GameData.Instance.coopTrailID == 0 && GameData.Instance.SkirmishGameType == 1)
			{
				...
				if (flag)
				{
					...
					MainViewModel.Instance.MO_MP_Score = (Visibility)1;
					MainViewModel.Instance.MO_SP_Score = true;
					MainViewModel.Instance.MO_MP_Victory = (Visibility)1;
					MainViewModel.Instance.MO_MP_Defeat = (Visibility)0;
				...
				if (flag2)
				{
					...
					ShownWeaselTurd = true;
					((UIElement)RefCoopCompletion).Visibility = (Visibility)2;
	...
	public void UpdateHelpText(int helpType)
	{
	...
	public void PlayBackgroundVideo(bool state)
	{
		...
		MainViewModel.Instance.Show_HUD_MissionOver_Video = false;
		if ((BaseComponent)(object)refMissionOverVideo != (BaseComponent)null)
		{
			refMissionOverVideo.Stop();
			refMissionOverVideo.Source = null;
			refMissionOverVideo.Close();
	...
	{
		GUI.LoadComponent((object)this, "Assets/GUI/XAMLResources/HUD_MissionOver.xaml");
	}
}
