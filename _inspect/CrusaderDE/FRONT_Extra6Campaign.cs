...
public class FRONT_Extra6Campaign : UserControl
{
	...
	{
		NoesisUnity.LoadComponent((object)this, "Assets/GUI/XAMLResources/FRONT_Extra6Campaign.xaml");
	}
	...
	public void CampaignMenuCommandEnter(object sender, MouseEventArgs e)
	{
		...
		case "65":
		{
			int num = int.Parse(text, Director.defaultCulture) - 40 + 5;
			int difficulty = 0;
