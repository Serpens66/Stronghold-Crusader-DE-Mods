...
public class MapFileManager
{
	...
	private string TrailMakerPath;

	private string CustomTrailsPath;
	...
	private Dictionary<string, FileHeader> TrailMakerFiles = new Dictionary<string, FileHeader>();

	private Dictionary<string, CustomTrailInfo> CustomTrails = new Dictionary<string, CustomTrailInfo>();

	private Dictionary<string, FileHeader> UserWorkshopUploads = new Dictionary<string, FileHeader>();

	private bool pauseTrailMakerWatcher;
	...
	private FileSystemWatcher trailMakerWatcher;

	private int[] classicSortOrder8 = new int[9] { 0, 1, 7, 6, 5, 4, 3, 2, 8 };

	private int[] classicSortOrder7 = new int[9] { 0, 1, 6, 5, 4, 3, 2, 8, 7 };

	private int[] classicSortOrder6 = new int[9] { 0, 1, 5, 4, 3, 2, 8, 7, 6 };

	private int[] classicSortOrder5 = new int[9] { 0, 1, 4, 3, 2, 8, 7, 6, 5 };

	private int[] classicSortOrder4 = new int[9] { 0, 1, 3, 2, 8, 7, 6, 5, 4 };

	private int[] classicSortOrder3 = new int[9] { 0, 1, 2, 8, 7, 6, 5, 4, 3 };

	private int[] classicSortOrder2 = new int[9] { 0, 1, 8, 7, 6, 5, 4, 3, 2 };

	private Texture2D radarPreviewTexture;

	private Texture2D radarLoadSavePreviewTexture;
	...
	private void UpdateUserMap(string file, string realFileName)
	{
		file = file.Replace('/', '\\');
	...
	private void UpdateWorkshopMap(string file, string realFileName)
	{
		file = file.Replace('/', '\\');
	...
	private void UpdateBuiltinMap(string file, string realFileName)
	{
		file = file.Replace('/', '\\');
	...
	private void UpdateUserWorkshopUploads(string file, string realFileName)
	{
		file = file.Replace('/', '\\');
		FileHeader fileInfoFromFileName = GetFileInfoFromFileName(file, realFileName, 0);
	...
	private void UpdateUserSave(string file, string realFileName)
	{
		file = file.Replace('/', '\\');
		FileHeader fileInfoFromFileName = GetFileInfoFromFileName(file, realFileName, 0);
		if (fileInfoFromFileName != null)
	...
	private void UpdateUserMPSave(string file, string realFileName)
	{
		file = file.Replace('/', '\\');
		FileHeader fileInfoFromFileName = GetFileInfoFromFileName(file, realFileName, 0);
		if (fileInfoFromFileName != null)
	...
	private void UpdateTrailMakerFile(string file, string realFileName)
	{
		file = file.Replace('/', '\\');
	...
	private void RemoveTrailMakerFile(string file)
	{
		file = file.Replace('/', '\\');
	...
	private void UpdateCustomTrailFile(string trailName, string file, string realFileName)
	{
		file = file.Replace('/', '\\');
	...
	private void RemoveCustomTrailFile(string trailName, string file)
	{
		file = file.Replace('/', '\\');
		if (TrailMakerFiles.ContainsKey(file))
		{
	...
	private void CreateWatchers()
	{
		...
		trailMakerWatcher.NotifyFilter = NotifyFilters.Attributes | NotifyFilters.CreationTime | NotifyFilters.DirectoryName | NotifyFilters.FileName | NotifyFilters.LastAccess | NotifyFilters.LastWrite | NotifyFilters.Security | NotifyFilters.Size;
	...
	private void OnChangedTrailMaker(object sender, FileSystemEventArgs e)
	{
	...
	private void OnCreatedTrailMaker(object sender, FileSystemEventArgs e)
	{
	...
	private void OnDeletedTrailMaker(object sender, FileSystemEventArgs e)
	{
		if (!pauseTrailMakerWatcher && e.FullPath.ToLower().EndsWith(".trail"))
		{
	...
	private void OnRenamedTrailMaker(object sender, RenamedEventArgs e)
	{
	...
	{
		if (radarLoadSavePreviewTexture == null)
		{
			radarLoadSavePreviewTexture = new Texture2D(200, 200, TextureFormat.BGRA32, mipChain: false);
			radarLoadSavePreviewTexture.filterMode = FilterMode.Point;
		}
		radarLoadSavePreviewTexture.SetPixelData(radarMapPreview, 0);
