...
public class Translate
{
	...
	private readonly string StrongholdTextFileNew = "Assets/Text/Crusader.txt";
	...
	private const int maxTextSections = 370;
	...
	private string[] SectionNames = new string[370]
	{
	...
	private Dictionary<string, int> builtInMapDescExtremeTranslations;
	...
	private void CONVERT_FILENAME(string mapName, int textID, int descID = -1)
	{
	...
	public string translateMapNames(string userMapName, ref string description)
	{
		...
		if (builtInMapNameTranslations == null)
		{
			...
			CONVERT_FILENAME("AcrossTheStream", 381);
			CONVERT_FILENAME("ALongWayUp", 383);
			CONVERT_FILENAME("ConfusingCliffs", 385);
			CONVERT_FILENAME("FloodedPlains", 387);
			CONVERT_FILENAME("RingOfSafety", 389);
			CONVERT_FILENAME("IronDefence", 391);
			CONVERT_FILENAME("RiverPass", 393);
			CONVERT_FILENAME("OverlookPlateau", 395);
			CONVERT_FILENAME("TheShallows", 397);
			CONVERT_FILENAME("ABridgeApart", 399);
			CONVERT_FILENAME("CrusadesCrossing", 401);
			CONVERT_FILENAME("Island Living", 403);
			CONVERT_FILENAME("Coast LIfe", 405);
			CONVERT_FILENAME("Insular Hope", 407);
			CONVERT_FILENAME("Bypass", 409);
			CONVERT_FILENAME("LushCrossover", 411);
			CONVERT_FILENAME("RiverOfLife", 413);
			CONVERT_FILENAME("Fields And Forges", 415);
			CONVERT_FILENAME("Rockhold", 417);
