...
public class EngineInterface
{
	...
	private const int CHIMPS_LIMIT = 10000;

	public static bool flattenedLandscape = false;

	private static int[] selectedChimps = new int[20000];
	...
	private unsafe static LoadMapReturnData loadMap(int campaignMapID, string fileName = "", bool dummy = false, bool multiplayerSave = false, int trailType = -1, int trailID = 0, bool allow_classic_bedouins = false)
	{
		lock (threadLock)
		{
