...
public class EngineInterface
{
	...
	public class MultiplayerSetupData
	{
		...
		{
			if (advopt_pre_build <= 0 && advopt_improved_arabswordsmen <= 0 && advopt_improved_laddermen <= 0 && advopt_improved_spearmen <= 0 && advopt_rebalanced_horsearchers <= 0 && advopt_improved_fletchers <= 0 && advopt_uncapped_peasants <= 0 && advopt_faster_peasants <= 0 && advopt_enemy_hps == 1 && global_improved_sieging <= 0 && advopt_healers <= 0 && advopt_eunuchs <= 0)
			{
				return advopt_nogold > 0;
			}
			return true;
		}
		...
		{
			return "-3," + advanced_skirmish_options + "," + advopt_pre_build + "," + advopt_improved_arabswordsmen + "," + advopt_improved_laddermen + "," + advopt_improved_spearmen + "," + advopt_rebalanced_horsearchers + "," + advopt_improved_fletchers + "," + advopt_uncapped_peasants + "," + advopt_faster_peasants + "," + advopt_enemy_hps + "," + global_improved_sieging + "," + advopt_healers + "," + advopt_eunuchs + "," + advopt_nogold + ",";
		}
