...
source = (root / 'MoveMoatTest/src/MoveMoatPathTest.cs').read_text(encoding='utf-8-sig')
...
recovery = (root / 'MoveMoatTest/src/NativeMovementRecovery.cs').read_text(encoding='utf-8-sig')
...
stub=(root/'_inspect/MoveMoatRegressionTests/latest-recovery-stub.bin').read_bytes()
