...
internal static class Program
{
    ...
    private static int Main()
    {
        try
        {
            ...
            CheckPolicy();
            Console.WriteLine($"PASS: EngineerSiegeFixTest tests ({assertions} assertions).");
            return 0;
        }
    ...
    private static void CheckSourceContracts(string workspace)
    {
        ...
        Check(plugin.Contains("private static EngineerSiegeFixTestRuntime runtime"),
