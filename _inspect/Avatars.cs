...
public class Avatars
{
	...
	public class AvatarItemDefinition
	{
	...
	public Dictionary<Enums.AvatarItems, AvatarData> avatarItems = new Dictionary<Enums.AvatarItems, AvatarData>();

	public AvatarItemDefinition[] colourLoader = new AvatarItemDefinition[50]
	{
	...
	public AvatarItemDefinition[] maskLoader = new AvatarItemDefinition[91]
	{
	...
	public AvatarItemDefinition[] itemLoader = new AvatarItemDefinition[86]
	{
	...
	public bool avatarsInitialised;
	...
	public byte[] loadSolid(string fileName)
	{
		...
		Color[] array2 = loadImage(fileName);
		if (array2 == null)
		{
			return null;
		}
		int num = 0;
		Color[] array3 = array2;
		foreach (Color val in array3)
		{
			array[num] = (byte)(val.r * 255f);
			array[num + 1] = (byte)(val.g * 255f);
			array[num + 2] = (byte)(val.b * 255f);
			num += 3;
		}
		return array;
	}

	public byte[] loadMask(string fileName)
	{
		//IL_0024: Unknown result type (might be due to invalid IL or missing references)
		//IL_0029: Unknown result type (might be due to invalid IL or missing references)
		//IL_002d: Unknown result type (might be due to invalid IL or missing references)
	...
	public byte[] loadOverlay(string fileName)
	{
		//IL_0024: Unknown result type (might be due to invalid IL or missing references)
		//IL_0029: Unknown result type (might be due to invalid IL or missing references)
		//IL_002d: Unknown result type (might be due to invalid IL or missing references)
		...
		foreach (Color val in array3)
		{
			...
			array[num + 1] = (byte)(val.g * 255f);
			array[num + 2] = (byte)(val.b * 255f);
			array[num + 3] = (byte)(val.a * 255f);
			num += 4;
		}
		return array;
	}

	public ImageSource loadIcon(string fileName)
	{
		//IL_0024: Unknown result type (might be due to invalid IL or missing references)
		//IL_0029: Unknown result type (might be due to invalid IL or missing references)
		...
		if (fileName.Length > 0)
		{
			try
			{
				byte[] array = File.ReadAllBytes("Assets/GUI/Avatars/" + fileName + ".png");
				Texture2D val = new Texture2D(2, 2, (TextureFormat)4, false, true);
				ImageConversion.LoadImage(val, array);
				TextureSource result = new TextureSource(val);
				Object.DestroyImmediate((Object)val);
				return (ImageSource)(object)result;
			}
			catch (Exception)
			{
			}
	...
	public AvatarData getAvatarData(Enums.AvatarItems item)
	{
	...
	public TextureSource GetAvatarTexture(AvatarDesign design, bool featherEdge = true, bool UIListVariant = false, bool saveAvatar = false)
	{
		...
		Color[] array = (Color[])(object)new Color[67600];
		Texture2D tempTex = new Texture2D(260, 260, (TextureFormat)4, false, true);
		...
		if (avatarData != null && avatarData.dataSolid != null)
		{
			...
			else
			{
				...
				{
					((Color)(ref val2))._002Ector((float)(int)avatarData.dataSolid[j * 3] / 255f, (float)(int)avatarData.dataSolid[j * 3 + 1] / 255f, (float)(int)avatarData.dataSolid[j * 3 + 2] / 255f, 1f);
					array[j] = val2;
				}
			}
			if (design.item == Enums.AvatarItems.None && design.background == Enums.AvatarItems.BackMask_091)
			{
				...
				((Color)(ref val3))._002Ector(0f, 0f, 0f, 1f);
				for (uint num = 0u; num < 260; num++)
				{
					for (uint num2 = 0u; num2 < 260; num2++)
					{
						array[num2 + num * 260].a = 1f;
						array[num2 + num * 260].r = val3.r;
						array[num2 + num * 260].g = val3.g;
						array[num2 + num * 260].b = val3.b;
					}
				}
			}
			...
			if (avatarData2 != null && avatarData2.dataMask1 != null && avatarData3 != null && avatarData3.dataSolid != null && design.background != Enums.AvatarItems.BackMask_091)
			{
				for (int k = 0; k < 67600; k++)
				{
					...
					if (num3 != 0f)
					{
						if (num3 == 1f)
						{
							array[k] = new Color((float)(int)avatarData3.dataSolid[k * 3] / 255f, (float)(int)avatarData3.dataSolid[k * 3 + 1] / 255f, (float)(int)avatarData3.dataSolid[k * 3 + 2] / 255f);
							continue;
						}
						array[k].r *= 1f - num3;
						array[k].g *= 1f - num3;
		...
		else
		{
			...
			((Color)(ref val4))._002Ector(0f, 0f, 0f, 0.5f);
		...
		if (avatarData4 != null && avatarData4.dataOverlay != null)
		{
			if (avatarData4.dataMask1 != null && avatarData5 != null && avatarData5.dataSolid != null)
			{
				for (int m = 0; m < 67600; m++)
				{
					...
					if (num4 != 0f)
					{
						if (num4 == 1f)
						{
							array[m] = new Color((float)(int)avatarData5.dataSolid[m * 3] / 255f, (float)(int)avatarData5.dataSolid[m * 3 + 1] / 255f, (float)(int)avatarData5.dataSolid[m * 3 + 2] / 255f);
						}
			...
			if (avatarData4.dataMask2 != null && avatarData6 != null && avatarData6.dataSolid != null)
			{
				for (int n = 0; n < 67600; n++)
				{
					...
					if (num5 == 1f)
					{
						array[n] = new Color((float)(int)avatarData6.dataSolid[n * 3] / 255f, (float)(int)avatarData6.dataSolid[n * 3 + 1] / 255f, (float)(int)avatarData6.dataSolid[n * 3 + 2] / 255f);
						continue;
					}
					array[n].r *= 1f - num5;
					array[n].g *= 1f - num5;
			...
			for (int num6 = 0; num6 < 67600; num6++)
			{
				...
				if (num7 == 1f)
				{
					array[num6] = new Color((float)(int)avatarData4.dataOverlay[num6 * 4] / 255f, (float)(int)avatarData4.dataOverlay[num6 * 4 + 1] / 255f, (float)(int)avatarData4.dataOverlay[num6 * 4 + 2] / 255f);
					continue;
				}
		...
		if (saveAvatar)
		{
			...
			if (File.Exists(path))
			{
				...
				{
					Object.DestroyImmediate((Object)(object)tempTex);
				});
			}
			else
			{
		...
		TextureSource val5 = new TextureSource(tempTex);
		Object.DestroyImmediate((Object)(object)tempTex);
		return val5;
	}

	public void OutputCoAPNG(string path, Texture2D tempTex)
	{
	...
	{
		Platform_Multiplayer.Instance.SetCoatOfArms((ImageSource)(object)Instance.GetAvatarTexture(ConfigSettings.getAvatar()));
	}
}
