...
$settings = [ordered]@{
    ...
    SpawnCastle = 'SpawnCastle/BepInEx/plugins/SpawnCastle_Serp/Override/ScriptExtenderUI/SpawnCastleSettings.xaml'
...
$localeDirectories = [ordered]@{
    ...
    SpawnCastle = 'SpawnCastle/BepInEx/plugins/SpawnCastle_Serp/Locales'
