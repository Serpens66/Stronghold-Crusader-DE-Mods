...
public class ConfigSettings
{
	...
	public static bool _settingsFileExisted = false;

	public static string settings_UserName = "Lord Crusader";

	public static string settings_NewsletterEmail = "";

	public static int[] settings_Trail1Times = new int[50];

	public static int[] settings_Trail2Times = new int[30];

	public static int[] settings_Trail3Times = new int[20];

	public static int[] settings_Trail_Sands1_Times = new int[5];

	public static int[] settings_Trail_Sands2_Times = new int[7];

	public static int[] settings_Trail_Sands3_Times = new int[9];

	public static int[] settings_Trail_Sands4_Times = new int[11];

	public static int[] settings_Trail_Sands5_Times = new int[9];

	public static int[] settings_Trail_Sands6_Times = new int[9];

	public static int[] settings_Trail_Sands7_Times = new int[9];

	public static bool settings_ShowSandsIntro = true;

	public static bool settings_PushMapScrolling = true;

	public static bool settings_SH1MouseWheel = false;

	public static bool settings_SH1RTSControls = true;

	public static bool settings_SH1CentreControls = true;

	public static bool settings_ShowBuildingTooltips = true;

	public const float Default_MusicVolume = 1f;

	public static float settings_MusicVolume = 1f;

	public const float Default_SpeechVolume = 1f;

	public static float settings_SpeechVolume = 1f;

	public const float Default_UnitSpeechVolume = 1f;

	public static float settings_UnitSpeechVolume = 1f;

	public const float Default_SFXVolume = 1f;

	public static float settings_SFXVolume = 1f;

	public const float Default_MasterVolume = 0.8f;

	public static float settings_MasterVolume = 0.8f;

	public static bool settings_PlayUISFX = true;

	public static bool settings_GenieSpeech = true;

	public static bool settings_MuteInsults = false;

	public static bool settings_MuteInsultSpeech = false;

	public static bool settings_BackgroundAudio = true;

	public static bool settings_ReduceMusicVolumeForSpeech = true;

	public static bool settings_UseSteamOverlayForHelp = false;

	public static bool settings_CheatKeysEnabled = false;

	public static bool settings_CoopCheatsEnabled = false;

	public static bool settings_ShowPings = false;

	public static bool settings_ExtraZoom = true;

	public static bool settings_Leaderboard_OptOut = false;

	public static bool settings_Leaderboard_Names = false;

	public static bool settings_Leaderboard_Images = false;

	public static bool settings_Show_Extreme_Warning = true;

	public const int Default_ScrollSpeed = 5;

	public static int settings_ScrollSpeed = 5;

	public static bool settings_Confirm_Disband_Troops = true;

	public static bool settings_ArabicL2R = false;

	public static bool settings_Compass = false;

	public static bool settings_ShowGameTime = false;

	public static bool settings_ShowLocalTime = false;

	public static bool settings_ShowSandsTimer = true;

	public static bool settings_RadarDefaultZoomedOut = false;

	public static bool settings_CustomIntros = true;

	public const int Default_GameSpeed = 40;

	public static int settings_GameSpeed = 40;

	public static bool settings_ShowPlannedMoat = false;

	public static bool settings_LockCursor = false;

	public static bool settings_Vsync = false;

	public static bool settings_EnglishSpeech = false;

	public static bool settings_SkipIntro = false;

	public static int settings_Scribe = 2;

	public static bool settings_HideSoTTiming = false;

	public static bool settings_Allow_Classic_Bedouin_Stockade = false;

	public static bool settings_ShowCustomisationWarning = true;

	public static int settings_LordType = 0;

	public static int settings_AvatarOrdinary = 1002;

	public static int settings_AvatarOrdinaryColour1 = 22;

	public static int settings_AvatarOrdinaryColour2 = 11;

	public static int settings_AvatarCharge = 2019;

	public static int settings_AvatarChargeColour1 = 10;

	public static int settings_AvatarChargeColour2 = 110;

	public static bool settings_UseSteamAvatar = false;

	public static bool settings_MuteMPChat = false;

	public static int settings_CursorStyle = 0;

	public static int settings_PlayerColour = 0;

	public static int settings_LastWindowWidth = -1;

	public static int settings_LastWindowHeight = -1;

	public static int settings_LastFullscreenWidth = -1;

	public static int settings_LastFullscreenHeight = -1;

	public static int settings_LastFullscreenRefresh = -1;

	public static int settings_LastFullscreenType = -1;

	public static float settings_UIScale = 1f;
	...
	public static int settings_Progress_Historical1Campaign = 1;

	public static int settings_Progress_Historical2Campaign = 1;

	public static int settings_Progress_Historical3Campaign = 1;

	public static int settings_Progress_Historical4Campaign = 1;

	public static int settings_Progress_Historical5Campaign = 1;

	public static int settings_Progress_Historical6Campaign = 1;

	public static int settings_Progress_Historical7Campaign = 1;

	public static int settings_Progress_Trail = 1;

	public static int settings_Progress_Trail2 = 1;

	public static int settings_Progress_Trail3 = 1;

	public static int settings_Progress_Trail_Sands1 = 1;

	public static int settings_Progress_Trail_Sands2 = 1;

	public static int settings_Progress_Trail_Sands3 = 1;

	public static int settings_Progress_Trail_Sands4 = 1;

	public static int settings_Progress_Trail_Sands5 = 1;

	public static int settings_Progress_Trail_Sands6 = 1;

	public static int settings_Progress_Trail_Sands7 = 1;

	public static bool settings_ShowExtremeHelp = true;

	public static bool settings_DLC3_Pip1 = true;

	public static bool settings_DLC3_Pip2 = true;

	public static bool settings_DLC3_Pip3 = true;

	public static bool settings_DLC3_Pip4 = true;

	public static bool settings_DLC3_Pip5 = true;

	public static bool settings_DLC3_Pip6 = true;

	public static bool settings_DLC2_Pip11 = true;

	public static int settings_Trail1Difficulty = 1;

	public static int settings_Trail2Difficulty = 1;

	public static int settings_Trail3Difficulty = 1;

	public static int settings_SandsTrail1Difficulty = 1;

	public static int settings_SandsTrail2Difficulty = 1;

	public static int settings_SandsTrail3Difficulty = 1;

	public static int settings_SandsTrail4Difficulty = 1;

	public static int settings_SandsTrail5Difficulty = 1;

	public static int settings_SandsTrail6Difficulty = 1;

	public static int settings_SandsTrail7Difficulty = 1;

	public static bool muteSounds = false;

	public static string[] extendedLordPaths = new string[27]
	{
		...
		"Canary", "Trader", "Sergeant", "Lioness", "Crocodile", "Baldwin", "Bullseye"
	};

	public static Dictionary<string, Scores> scores = new Dictionary<string, Scores>();

	public static SkirmishMasters skirmishMasters = null;
	...
	public static Dictionary<ulong, Coop> coopInfoDict = new Dictionary<ulong, Coop>();

	public static List<Coop> coopInfoList = new List<Coop>();

	public static Dictionary<string, int[]> customTrailCompleted = new Dictionary<string, int[]>();
	...
	public static bool Settings_DLC3_Pip1
	{
		get
		{
			return settings_DLC3_Pip1;
		}
		set
		{
			if (settings_DLC3_Pip1 != value)
			{
				settingsDirty = true;
				settings_DLC3_Pip1 = value;
			}
		}
	}

	public static bool Settings_DLC3_Pip2
	{
		get
		{
			return settings_DLC3_Pip2;
		}
		set
		{
			if (settings_DLC3_Pip2 != value)
			{
				settingsDirty = true;
				settings_DLC3_Pip2 = value;
			}
		}
	}

	public static bool Settings_DLC3_Pip3
	{
		get
		{
			return settings_DLC3_Pip3;
		}
		set
		{
			if (settings_DLC3_Pip3 != value)
			{
				settingsDirty = true;
				settings_DLC3_Pip3 = value;
			}
		}
	}

	public static bool Settings_DLC3_Pip4
	{
		get
		{
			return settings_DLC3_Pip4;
		}
		set
		{
			if (settings_DLC3_Pip4 != value)
			{
				settingsDirty = true;
				settings_DLC3_Pip4 = value;
			}
		}
	}

	public static bool Settings_DLC3_Pip5
	{
		get
		{
			return settings_DLC3_Pip5;
		}
		set
		{
			if (settings_DLC3_Pip5 != value)
			{
				settingsDirty = true;
				settings_DLC3_Pip5 = value;
			}
		}
	}

	public static bool Settings_DLC3_Pip6
	{
		get
		{
			return settings_DLC3_Pip6;
		}
		set
		{
			if (settings_DLC3_Pip6 != value)
			{
				settingsDirty = true;
				settings_DLC3_Pip6 = value;
			}
		}
	}

	public static bool Settings_DLC2_Pip11
	{
		get
		{
			return settings_DLC2_Pip11;
		}
		set
		{
			if (settings_DLC2_Pip11 != value)
			{
				settingsDirty = true;
				settings_DLC2_Pip11 = value;
			}
		}
	}
	...
	public static void loadSettingsFromString(string settingsString)
	{
			...
			foreach (string text in array2)
			{
				try
				{
					...
					case "trails1times":
					{
						...
						{
							settings_Trail_Sands1_Times[num4] = int.Parse(array3[num4 + 1], Director.defaultCulture);
						}
						break;
					}
					case "trails2times":
					{
						...
						{
							settings_Trail_Sands2_Times[num3] = int.Parse(array3[num3 + 1], Director.defaultCulture);
						}
						break;
					}
					case "trails3times":
					{
						...
						{
							settings_Trail_Sands3_Times[num] = int.Parse(array3[num + 1], Director.defaultCulture);
						}
						break;
					}
					case "trails4times":
					{
						for (int n = 0; n < 11; n++)
						{
							settings_Trail_Sands4_Times[n] = int.Parse(array3[n + 1], Director.defaultCulture);
						}
						break;
					}
					case "trails5times":
					{
						for (int l = 0; l < 9; l++)
						{
							settings_Trail_Sands5_Times[l] = int.Parse(array3[l + 1], Director.defaultCulture);
						}
						break;
					}
					case "trails6times":
					{
						for (int k = 0; k < 9; k++)
						{
							settings_Trail_Sands6_Times[k] = int.Parse(array3[k + 1], Director.defaultCulture);
						}
						break;
					}
					case "trails7times":
					{
						for (int j = 0; j < 9; j++)
						{
							settings_Trail_Sands7_Times[j] = int.Parse(array3[j + 1], Director.defaultCulture);
						}
						break;
					}
					case "gamespeed":
					...
					case "avatarcharge":
						...
						if (settings_AvatarCharge < 2000 || settings_AvatarCharge > 2089)
						{
					...
					case "dlc3pips":
					{
						string[] array7 = array3[1].Split(",", StringSplitOptions.None);
						if (array7.Length == 6)
						{
							settings_DLC3_Pip1 = bool.Parse(array7[0]);
							settings_DLC3_Pip2 = bool.Parse(array7[1]);
							settings_DLC3_Pip3 = bool.Parse(array7[2]);
							settings_DLC3_Pip4 = bool.Parse(array7[3]);
							settings_DLC3_Pip5 = bool.Parse(array7[4]);
							settings_DLC3_Pip6 = bool.Parse(array7[5]);
							if (array7.Length == 10)
							{
								settings_DLC2_Pip11 = true;
							}
							else
							{
								settings_DLC2_Pip11 = bool.Parse(array7[10]);
							}
						}
						break;
					}
	...
	public static string createSettingString()
	{
		...
		text = text + "DLC3Pips:" + settings_DLC3_Pip1 + "," + settings_DLC3_Pip2 + "," + settings_DLC3_Pip3 + "," + settings_DLC3_Pip4 + "," + settings_DLC3_Pip5 + "," + settings_DLC3_Pip6 + "\n";
	...
	public static string GetSkirmishMastersFileName()
	{
	...
	public static void SaveSkirmishMasters()
	{
		string skirmishMastersFileName = GetSkirmishMastersFileName();
		try
		{
			string contents = JsonUtility.ToJson((object)skirmishMasters);
	...
	public static void LoadSkirmishMasters()
	{
		string skirmishMastersFileName = GetSkirmishMastersFileName();
		try
		{
	...
	public static void ReIndexSkirmishMasters()
	{
		int num = 0;
		foreach (EngineInterface.MPScoreData skirmishMastersDatum in skirmishMasters.skirmishMastersData)
		{
	...
	public static string GetCoopFileName()
	{
	...
	public static void CalcCoopProgress(ulong steamID, bool capProgress = false)
	{
		...
		case 0uL:
		{
			...
			for (int l = 0; l < 10; l++)
			{
				Settings_Progress_Trail_Coop1_Status[l] = num4;
				Settings_Progress_Trail_Coop2_Status[l] = num4;
				Settings_Progress_Trail_Coop3_Status[l] = num4;
			}
			foreach (KeyValuePair<ulong, Coop> item in coopInfoDict)
			{
				for (int m = 0; m < 10; m++)
			...
			for (int num5 = 9; num5 >= 0; num5--)
			{
				if (Settings_Progress_Trail_Coop1_Status[num5] > 0)
				{
					Settings_Progress_Trail_Coop1 = num5 + 2;
					break;
				}
			}
			for (int num6 = 9; num6 >= 0; num6--)
			{
				if (Settings_Progress_Trail_Coop2_Status[num6] > 0)
				{
					Settings_Progress_Trail_Coop2 = num6 + 2;
					break;
				}
			}
			for (int num7 = 9; num7 >= 0; num7--)
			{
				if (Settings_Progress_Trail_Coop3_Status[num7] > 0)
				{
					Settings_Progress_Trail_Coop3 = num7 + 2;
					break;
				}
			}
			break;
		...
		{
			if (Settings_Progress_Trail_Coop2_Status[num8] == 0)
			{
				Settings_Progress_Trail_CoopNext2 = num8;
				break;
			}
		}
		...
		{
			if (Settings_Progress_Trail_Coop3_Status[num9] == 0)
			{
				Settings_Progress_Trail_CoopNext3 = num9;
				break;
			}
		}
	}

	public static string GetCustomTrailsCompletedFileName()
	{
		...
		try
		{
			...
			for (int i = 0; i < array.Length; i++)
			{
				...
				try
				{
					...
					string[] array4 = array2[1].Split(':', StringSplitOptions.None);
					if (array4.Length >= 50)
					{
						for (int j = 0; j < 50; j++)
						{
