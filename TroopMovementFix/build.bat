...
pushd "%PROJECT_DIR%"
"%MSBUILD%" TroopMovementFix.csproj /p:Configuration=Release /p:GameDir="%GAME_DIR%" /p:ExtenderDir="%EXTENDER_DIR%"
...
if "%BUILD_EXIT_CODE%"=="0" (
  ...
  set "PLUGIN_NAME=TroopMovementFix_Serp"
  set "OLD_PLUGIN_NAME=TroopMovementFix"
