...
namespace SomeSettings
{
    ...
    internal sealed unsafe class FastRecruitRallyMovementRuntime : IDisposable
    {
        ...
        private readonly SynchronizedMovementCadencePatch movementPatch;
        ...
        public FastRecruitRallyMovementRuntime(
            ManualLogSource log,
            SynchronizedMovementCadencePatch movementPatch)
        {
        ...
        public bool TryApplyRunningCadence(GameUnit* unit)
        {
