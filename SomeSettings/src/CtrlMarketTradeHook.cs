    ...
    internal sealed unsafe class CtrlMarketTradeHook : IDisposable
    {
            ...
            ReadOnlySpan<byte> memory)
        {
            ...
            try
            {
                ...
                nativeReady = true;
                Shared.DebugLogHelper.LogInfo(log, "SomeSettings Ctrl single-unit market hooks installed.");
            }
            catch
            {
                Dispose();
        ...
        public void Dispose()
        {
            ...
            Shared.DebugLogHelper.LogInfo(log, "SomeSettings Ctrl single-unit market hooks disposed.");
        }
        ...
        private void NoesisGuiUpdateHook(FatControler self)
        {
            ...
            {
                Shared.DebugLogHelper.LogError(log, $"SomeSettings Ctrl market UI update failed: {ex}");
            }
        }
