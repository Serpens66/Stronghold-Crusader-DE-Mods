...
namespace MoatMove
{
    internal sealed unsafe partial class FriendlyMoatMovementRuntime : IDisposable
    {
        ...
        public FriendlyMoatMovementRuntime(
            ManualLogSource log,
            MoatMoveOptions settings,
            ...
            bool referenceHashMatches)
        {
            ...
            try
            {
                ...
                Shared.DebugLogHelper.LogInfo(
                    log,
                    "Friendly Moat Movement final candidate installed: " +
            ...
            ReadOnlySpan<byte> memory, ulong libraryBase)
        {
            ...
            try
            {
                ...
                Shared.DebugLogHelper.LogInfo(
                    log,
                    "MoatMove friendly-moat-movement building cursor reachability installed: " +
            ...
            catch (Exception ex)
            {
                ...
                Shared.DebugLogHelper.LogError(
                    log,
                    "MoatMove friendly-moat-movement building cursor reachability was not installed; " +
        ...
        private void TryInstallAttackApproachDiagnostics(ReadOnlySpan<byte> memory, ulong libraryBase)
        {
            ...
            try
            {
                ...
                Shared.DebugLogHelper.LogInfo(
                    log,
                    "MoatMove friendly-moat-movement attack-approach hooks installed: " +
            ...
            catch (Exception ex)
            {
                ...
                Shared.DebugLogHelper.LogError(
                    log,
                    "MoatMove friendly-moat-movement shared E2610/attack-approach hooks were not installed; " +
        ...
        private void ObserveTrackedAttackStates(int tick)
        {
            ...
            if (activeMoveCommand != null)
            {
                ...
                {
                    LogDetailedInfo(
                        "MoatMove friendly-moat-movement " +
            ...
            int tick)
        {
            ...
            LogDetailedInfo(
                $"MoatMove stage=friendly-moat-movement-native-waypoint-queue source={source} tick={tick} " +
        ...
        private void EndTrackedAttack(int unitId, AttackUnitTracker tracker, string reason)
        {
            ...
            LogDetailedInfo(
                $"MoatMove stage=friendly-moat-movement-attack-state-end unit={unitId} command={tracker.Command} " +
        ...
        private void ObserveTrackedMoatMoveStates(int tick)
        {
            ...
            try
            {
                        ...
                        if (!tracker.PublishedLengthVerified)
                        {
                            if (contractCounts[2] <= 3)
                            {
                                Shared.DebugLogHelper.LogWarning(
                                    log,
                                    $"MoatMove stage=friendly-moat-movement-weighted-path-consumer-contract-invalid " +
                ...
                {
                    LogDetailedInfo(
                        $"MoatMove stage=friendly-moat-movement-weighted-path-consumer-contract-summary " +
            ...
            int tick, GameUnit* unit, MoatMoveTracker tracker)
        {
                    ...
                    out string rejectionReason))
            {
                        ...
                        StringComparison.Ordinal))
                {
                    tracker.LastRuntimeCadenceRejection = rejection;
                    LogDetailedInfo(
                        $"MoatMove stage=friendly-moat-movement-weighted-shadow-runtime unit={tracker.UnitId} " +
            ...
            if (tracker.RuntimeCadenceCaptured)
            {
                ...
                if (tracker.TileTransitionCount == 0 && !tracker.RuntimeCadenceChanged)
                {
                    ...
                    LogDetailedInfo(
                        $"MoatMove stage=friendly-moat-movement-weighted-shadow-runtime-rebase unit={tracker.UnitId} " +
                ...
                if (!tracker.RuntimeCadenceChanged)
                {
                    ...
                    LogDetailedInfo(
                        $"MoatMove stage=friendly-moat-movement-weighted-shadow-runtime-change unit={tracker.UnitId} " +
            ...
            MoatMoveTracker tracker, int tileId, GameUnit* unit, int tick)
        {
            ...
            else
            {
                ...
                LogDetailedInfo(
                    $"MoatMove stage=friendly-moat-movement-owner-safety-observation tick={tick} " +
            ...
            string milestone)
        {
            ...
            LogDetailedInfo(
                $"MoatMove stage=friendly-moat-movement-move-milestone event={milestone} tick={tick} " +
        ...
        private void EndTrackedMoatMove(int unitId, MoatMoveTracker tracker, string reason)
        {
            ...
            LogDetailedInfo(
                $"MoatMove stage=friendly-moat-movement-move-state-end unit={unitId} type={tracker.UnitType} " +
            ...
            IntPtr unitManager, int unitId)
        {
            ...
            try
            {
                ...
                LogDetailedInfo(
                    $"MoatMove stage=friendly-moat-movement-post-combat-repath-entered unit={unitId} " +
            ...
            try
            {
                ...
                try
                {
                    ...
                    LogDetailedInfo(
                        $"MoatMove stage=friendly-moat-movement-post-combat-repath-result unit={unitId} " +
        ...
        private void LogWeightedPublicationDecision(int unitId, string message)
        {
            ...
            BufferOrLogCommandDiagnostic(message.StartsWith("MoatMove friendly-moat-movement ", StringComparison.Ordinal)
                ? message.Substring("MoatMove friendly-moat-movement ".Length) : message);
        }
            ...
            int unitId)
        {
            ...
            try
            {
                ...
                {
                    LogDetailedInfo(
                        $"MoatMove stage=friendly-moat-movement-building-cursor-reachability " +
        ...
        private void LogUnscopedAttackMode(int unitId, GameUnit* unit, int vanillaResult)
        {
            ...
            LogDetailedInfo(
                $"MoatMove stage=friendly-moat-movement-attack-mode-unscoped unit={unitId} " +
        ...
        {
            LogDetailedInfo($"MoatMove friendly-moat-movement {message}.");
        }
        ...
        private void FlushRequiredBackgroundDiagnosticSummary()
        {
            ...
            if (requiredBackgroundSuppressedDiagnostics.Count == 0)
                return;
            LogDetailedInfo(
                $"MoatMove stage=friendly-moat-movement-background-diagnostics tick={requiredBackgroundDiagnosticTick} " +
        ...
        private void FlushAttackDiagnostics(AttackCommandScope command)
        {
            ...
            LogDetailedInfo(
                $"MoatMove stage=friendly-moat-movement-attack-command-performance commandSeq={command.Sequence} " +
        ...
        private void FlushCommandDiagnostics(MoveCommandScope command)
        {
            ...
            {
                LogDetailedInfo(
                    $"MoatMove stage=friendly-moat-movement-move-command-performance commandSeq={command.Sequence} " +
            ...
            {
                LogDetailedInfo(
                    $"MoatMove stage=friendly-moat-movement-move-command-diagnostics commandSeq={command.Sequence} " +
                    $"diagnostics={command.DiagnosticMessages}/{command.Diagnostics.Count} " +
        ...
        private void LogRejectedPlannerRoute(PlanScope plan, RouteProbeSummary summary)
        {
            ...
            LogDetailedInfo(
                $"MoatMove stage=friendly-moat-movement-planner-owner-rejected unit={plan.UnitId} player={plan.PlayerId} " +
        ...
        private void LogFailure(string stage, Exception ex)
        {
            ...
            Shared.DebugLogHelper.LogError(
                log,
                $"MoatMove friendly-moat-movement {stage} callback failed once; Vanilla behavior remains active: {ex}");
        }
        ...
        private void TryLogDiagnosticFailure(string stage, Exception ex)
        {
            try
            {
                ...
                Shared.DebugLogHelper.LogError(
                    log,
                    $"MoatMove friendly-moat-movement read-only diagnostic stage={stage} failed; " +
