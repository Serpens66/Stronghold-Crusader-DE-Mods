    ...
    internal sealed unsafe partial class FriendlyMoatMovementRuntime
    {
        ...
        private void CompletePlacementAdapterInstallation()
        {
            ...
            Shared.DebugLogHelper.LogInfo(log,
                "MoatMove friendly-moat-movement placement hooks installed: commonGroup=0x118E00 formationSlot=0xE1D30 assassinGroundSlot=0xE0970 unstack=0x181890 freePlace=0xF03C0; native Unit event retained, terrain unchanged.");
        }
