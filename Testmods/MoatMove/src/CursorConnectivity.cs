...
namespace MoatMove
{
    internal sealed unsafe partial class FriendlyMoatMovementRuntime
    {
        ...
        private void ObserveCursorPerformance()
        {
            ...
            LogDetailedInfo($"MoatMove stage=friendly-moat-movement-cursor-performance selected={selectedCursorIds.Length} queries={cursorQueries} " +
        ...
        private void DirtyCursorBuilding(int id)
        {
            ...
            int maxY = Math.Min(MapWidth - 1, bounds.MaxY + 2);
        ...
        private void RecordCursorDecision(string reason, AttackCursorPairScope scope)
        {
            ...
            LogDetailedInfo($"MoatMove stage=friendly-moat-movement-cursor-decision reason={reason} " +
