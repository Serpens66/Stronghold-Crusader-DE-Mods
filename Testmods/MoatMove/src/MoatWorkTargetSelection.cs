...
namespace MoatMove
{
    internal sealed unsafe partial class FriendlyMoatMovementRuntime
    {
            ...
            ReadOnlySpan<byte> memory, ulong libraryBase)
        {
            ...
            catch (Exception ex)
            {
                ...
                Shared.DebugLogHelper.LogError(
                    log,
                    "MoatMove friendly-moat-movement moat-work target selection was not installed; " +
        ...
        private void LogMoatWorkSelection(MoatWorkSelectionScope scope)
        {
            ...
            LogDetailedInfo(
                $"MoatMove stage=friendly-moat-movement-work-target-selection-fallback kind={kind} unit={scope.UnitId} " +
        ...
        private void LogResolvedFillMoatApproach(PendingFillMoatApproach pending)
        {
            ...
            LogDetailedInfo(
                $"MoatMove stage=friendly-moat-movement-work-approach-tile kind=fill unit={pending.UnitId} " +
        ...
        private void LogResolvedDigMoatTarget(PendingDigMoatTarget pending)
        {
            ...
            lastMoatWorkApproachByUnit[pending.UnitId] = signature;
            LogDetailedInfo(
                $"MoatMove stage=friendly-moat-movement-work-approach-tile kind=dig unit={pending.UnitId} " +
