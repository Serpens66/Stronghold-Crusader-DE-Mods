...
namespace MoatMove {
 ...
 internal readonly struct MovementOptionsSnapshot {
  ...
  internal static MovementOptionsSnapshot Capture(MoatMoveOptions settings) => new MovementOptionsSnapshot(settings.EnableMod,
   settings.RouteMode==1?RouteCalculationMode.RequiredOnly:RouteCalculationMode.Exact);
 }
 internal static class TestSettings {
  internal static readonly MoatMoveOptions Settings = new MoatMoveOptions();
 }
