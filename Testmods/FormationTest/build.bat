...
set "LOCAL_PLUGIN_DIR=%PROJECT_DIR%BepInEx\plugins\FormationTest_Serp"
set "GAME_PLUGIN_DIR=%GAME_DIR%\BepInEx\plugins\FormationTest_Serp"
if not exist "%LOCAL_PLUGIN_DIR%\FormationTest.dll" goto failed
if "%NO_INSTALL%"=="1" (
