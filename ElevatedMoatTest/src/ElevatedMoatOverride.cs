...
namespace ElevatedMoatTest
{
    internal sealed unsafe class ElevatedMoatOverride : IDisposable
    {
            ...
            bool referenceHashMatches)
        {
            ...
            try
            {
                ...
                Shared.DebugLogHelper.LogInfo(
                    log,
                    $"Elevated Moat Test active for all players and the editor; " +
        ...
        {
            // The callback intentionally does no diagnostic work. This validator can run during
            // cursor movement; suppression is provided solely by the context-hook placement.
        }
        ...
        private void RecordSuccessfulCorrection(bool restored)
        {
            ...
            Shared.DebugLogHelper.LogInfo(
                log,
                $"Elevated Moat Test healthy: corrections={total}, " +
        ...
        {
            // Suppression is supplied by the context-hook placement. Avoid all per-validation
            // diagnostics here because this path can run continuously while positioning objects.
        }
        ...
        private void LogCallbackFailure(string stage, Exception exception)
        {
            Shared.DebugLogHelper.LogError(
                log,
                $"Elevated Moat Test {stage} callback failed; the affected correction may be incomplete: {exception}");
        }
