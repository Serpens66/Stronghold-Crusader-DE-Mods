...
pushd "%PROJECT_DIR%"
"%MSBUILD%" TroopMovementFix2.csproj /p:Configuration=Release /p:GameDir="%GAME_DIR%" /p:ExtenderDir="%EXTENDER_DIR%"
...
if "%BUILD_EXIT_CODE%"=="0" (
  ...
  set "PLUGIN_NAME=TroopMovementFix2_Serp"
  set "OLD_PLUGIN_NAME=TroopMovementFix2"
  ...
  if exist "%GAME_DIR%\BepInEx\plugins\TroopMovementFix_Serp\" (
    ...
    echo TroopMovementFix2 wird wegen der deklarierten Inkompatibilitaet nicht gleichzeitig geladen.
  )
