    ...
    internal static void Validate()
    {
        ...
        try
        {
            ...
            object candidate = Activator.CreateInstance(type,
                new object[] { unchecked((ulong)memory.ToInt64()), 14, null!, "BugfixesAndQoL recovery span test" })!;
            try
            {
            ...
            ("B7321", "E84AF50D0085C0757E488BF333DB", 14) })
        {
            ...
            try
            {
                ...
                object candidate = Activator.CreateInstance(type,
                    new object[] { unchecked((ulong)fixture.ToInt64()), 14, null!, "BugfixesAndQoL Fast " + entry.Item1 })!;
                try
                {
