...
{
    internal static class ExtraFeaturesHookInfrastructure
    {
        internal static HookTransaction CreateOwnedTransaction(ScanRegion region) =>
            new HookTransaction(
                region,
        ...
        internal static void AddContextHook(
