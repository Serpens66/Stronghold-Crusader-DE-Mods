# ExtendedData guides / ExtendedData-Anleitungen

[English](#english) | [Deutsch](#deutsch)

## English

This directory collects user and developer documentation for `ExtendedData` and the file conventions it supports.
...
- [Mod-specific data for Custom Lord AICs](ModLordData.md#english) — For Lord and mod authors using the ExtendedData API to read GUID-namespaced data from `name.modlord.json` sidecars.
- [Mod-specific data for maps](ModMapData.md#english) — For map and mod authors embedding static GUID-namespaced data as `modmap.json`.

---

## Deutsch

Dieses Verzeichnis enthält Benutzer- und Entwicklerdokumentation für `ExtendedData` und die unterstützten Dateikonventionen.
...
- [Mod-spezifische Daten für Custom-Lord-AICs](ModLordData.md#deutsch) — Für Lord- und Modentwickler, die über die ExtendedData-API GUID-getrennte Daten aus `name.modlord.json`-Sidecars lesen.
- [Mod-spezifische Daten für Maps](ModMapData.md#deutsch) — Für Map- und Modentwickler, die statische GUID-getrennte Daten als `modmap.json` einbetten.
